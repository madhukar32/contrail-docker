{{/* ======================================================================= */}}
{{/* Controller container's contrailctl config is formed using this template */}}
{{/* ======================================================================= */}}
...
{{- if not .analytics_api.aaaMode -}}#{{- end -}}aaa_mode = {{- .analytics_api.aaaMode | default "no-auth" }}
