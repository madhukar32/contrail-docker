{{/* =============================================================== */}}
{{/* Analytics container's contrailctl config is formed using this template */}}
{{/* =============================================================== */}}
...
{{- if not .analyticsCollector.syslogPort-}}#{{- end -}}syslog_port = {{ .analyticsCollector.syslogPort | default -1 }}
...
{{- if not .analyticsCollector.analytics_config_audit_ttl -}}#{{- end -}}analytics_config_audit_ttl = {{ .analyticsCollector.analytics_config_audit_ttl | default 24 }}
...
{{- if not .snmpCollector.fastScanFre -}}#{{- end -}}fast_scan_frequency = {{ .snmpCollector.fastScanFre | default 60 }}
